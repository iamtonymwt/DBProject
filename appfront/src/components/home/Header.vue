<template>
    <div>
        <div class="top">
            <div class="center">
                <div style="width: 10%;float: left" id="gotoHome" class="collection">
                        <i class="el-icon-shopping-bag-1" v-on:click="backMainPage">回主页</i>
                </div>
                <ul class="f1">
                    <li style="margin-left: 20px"> <a >酒店信息比较平台</a></li>
                    <!-- <li style="margin-left: 10px"> <a >后台管理系统</a></li> -->
                    <li style="margin-left: 10px"> <a href="https://github.com/SunzeY/DBProject">GitHub地址</a></li>
                    <li style="margin-left: 10px"> <a >设计文档</a></li>
                    <li style="margin-left: 10px"> <a >问题反馈</a></li>
                </ul>
                <div style="width: 20%;float: left" v-show="this.$store.state.user.id === ''" >
                ...
                <div class="collection">
                    <i class="el-icon-s-custom" v-on:click="goUserCenter">用户中心</i>
                </div>
                <div id="map" class="collection">
                    <i class="el-icon-discover" v-on:click="gotoMap">可视化</i>
                </div>
            </div>
        </div>
